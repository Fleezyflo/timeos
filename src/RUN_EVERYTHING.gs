...
function RUN_EVERYTHING_NOW() {
  ...
  safeRun('validatePhase10_3_HumanStateSchema', validatePhase10_3_HumanStateSchema);
  safeRun('validatePhase10_3_LogLevelConfig', validatePhase10_3_LogLevelConfig);
